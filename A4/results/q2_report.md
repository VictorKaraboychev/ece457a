...
- Population size: `40`.
- Max fitness evaluations per run: `1200`.
- Independent runs per algorithm: `6`.
...
|---|---:|---:|---:|---:|
| PSO | 500.00 | 0.00 | 100.0% | 181.2 |
| ES (mu+lambda) | 500.00 | 0.00 | 100.0% | 257.2 |

## Answers to assignment questions (with evidence)

### 1) Which algorithm converges faster?
PSO converged faster.
...
Both are effectively tied in these experiments based on standard deviation of final fitness.
