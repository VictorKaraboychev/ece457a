...
- Population size: `40`.
- Max fitness evaluations per run: `3000`.
...
|---|---:|---:|---:|---:|
| PSO | 500.00 | 0.00 | 100.0% | 372.9 |
| ES (mu+lambda) | 500.00 | 0.00 | 100.0% | 355.9 |
...
ES is more stable in these experiments because it has the smaller standard deviation of final fitness.
